...
*(uint8_t*)(g_libGTASA+0x8ED875) = 1;							 
	...
	// 60 FPS
	WriteMemory(g_libGTASA+0x463FE8,(uintptr_t)"\x3C",1);
	WriteMemory(g_libGTASA+0x56C1F6,(uintptr_t)"\x3C",1);
	WriteMemory(g_libGTASA+0x56C126,(uintptr_t)"\x3C",1);
	WriteMemory(g_libGTASA+0x95B074,(uintptr_t)"\x3C",1);						  
	// CHud::SetHelpMessage
